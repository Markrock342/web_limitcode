  ...
  return (
    <div className="min-h-screen bg-slate-100 px-4 py-10">
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="mt-2 font-display text-2xl font-bold text-ink">ใบเสนอราคา</h1>
        <p className="mt-1 text-sm text-slate-600">เอกสารภายในสตูดิโอ — เปิดแล้วกดพิมพ์เพื่อบันทึกเป็น PDF</p>
